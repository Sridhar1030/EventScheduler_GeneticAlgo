            ...
            <div className="flex items-center align-middle justify-start space-x-11 h-20">
                <div className="flex justify-center align-middle">
                    ...
                    <div className='flex text-lg ml-14 space-x-10'>
                        ...
                        <button><Link to="/enrolled" className="hover:text-xl hover:text-white">Registered Participants</Link></button>
                ...
                <div className="absolute flex gap-2 justify-items-center items-center align-middle justify-start right-10 cursor-pointer">
                    ...
                    {[user ?
                        ...
                        <div className='flex flex-row-reverse'>
                            ...
                            <button><Link to="/login" onClick={logoutUser} className="  hover:text-red-500">Logout</Link>
                            </button>
                            <p className='mr-4 capitalize cursor-default'>Hello {user.username}</p>

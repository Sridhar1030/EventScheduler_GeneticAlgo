...
const YourEvents = () => {
    ...
    return (
        <>
            <div className='bg-gray-900 min-h-screen p-0 overflow-y-scroll overflow-x-hidden' style={{
                ...
                {registeredEvents.map(event => (
                    <div
                        ...
                        className='gap-10 w-96 h-36 mx-auto mt-10 mb-10 bg-blue-300 relative '
